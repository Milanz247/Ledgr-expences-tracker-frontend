  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardDescription>Monthly Commitment</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-bold text-slate-900">
                ...
                <div key={bill.id} className="flex items-center justify-between p-3 bg-white rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600">{bill.category.name}</p>
                    </div>
                  </div>
            ...
            <Card key={transaction.id} className="hover:shadow-md transition-shadow">
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between">
                  ...
                  <Badge className={getFrequencyBadge(transaction.frequency)}>
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-xl font-bold text-slate-900">{formatCurrency(transaction.amount)}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm text-slate-600">Next Due</p>
                    <p className="text-sm font-semibold text-slate-900">{formatDate(transaction.next_due_date)}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between pt-2 border-t border-slate-100">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <Power className={`h-4 w-4 ${transaction.is_active ? 'text-green-600' : 'text-slate-400'}`} />
                    </Button>
                    <Button
                      variant="ghost"
                      size="sm"
      ...
      <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
        <DialogContent className="max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleCreateRecurring} className="p-6 space-y-4">
            <div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                placeholder="Monthly streaming subscription"
              />
            </div>
            ...
            <div>
              ...
              {!paymentSourcesLoading && bankAccounts.length === 0 && (
                <p className="text-xs text-slate-500 mt-1">No bank accounts found</p>
              )}
            </div>
            ...
            <div>
              ...
              {!paymentSourcesLoading && fundSources.length === 0 && (
                <p className="text-xs text-slate-500 mt-1">No cash wallets found</p>
              )}
            </div>
            ...
            <div>
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-sm text-slate-700">
                  Notify me 3 days before due date
                </span>
              </label>
            </div>
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent className="max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleEditRecurring} className="p-6 space-y-4">
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">
                Name *
              </label>
            ...
            {formData.frequency === 'monthly' && (
              <div>
                ...
                <input
                  ...
                  placeholder="1-28"
                />
                <p className="text-xs text-slate-500 mt-1">Choose day 1-28 to avoid month-end issues</p>
              </div>
            )}
