...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        'fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto max-h-[96vh] flex-col rounded-t-2xl border-t border-zinc-200/60 bg-white shadow-[0_-10px_40px_-10px_rgba(0,0,0,0.15)]',
        className
      )}
      {...props}
    >
